...
Yearly.TN.Plot <- ggplot(Yearly.Averages, aes(x=year, y=mean_TN, group=MonitoringStation, color=MonitoringStation)) +
  geom_line() +
  ggtitle("Yearly Mean Values for TN at Each Monitoring Station") +
  xlab("Year") +
...
Yearly.TP.Plot <- ggplot(Yearly.Averages, aes(x=year, y=mean_TP, group=MonitoringStation, color=MonitoringStation)) +
  geom_line() +
  ggtitle("Yearly Mean Values for TP at Each Monitoring Station") +
  xlab("Year") +
  ylab("Concentration (mg/L)") + 
  geom_vline(xintercept = 2010, linetype = "dashed", color = "black", size = 1) +
  scale_x_continuous(breaks=seq(1985,2025,5))
...
Yearly.TSS.Plot <- ggplot(Yearly.Averages, aes(x=year, y=mean_TSS, group=MonitoringStation, color=MonitoringStation)) +
  geom_line() +
  ggtitle("Yearly Mean Values for TSS at Each Monitoring Station") +
  xlab("Year") +
  ylab("Concentration (mg/L)") + 
  geom_vline(xintercept = 2010, linetype = "dashed", color = "black", size = 1) +
  scale_x_continuous(breaks=seq(1985,2025,5))
