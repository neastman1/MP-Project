...
BXK0031_TN.Early.ts <- ts(BXK0031_TN_TP_TSS.Early$meanTN, start = c(2003,3), frequency =12)
...
##should ask Luana about how to interpret the stats of this test!!
...
##with ggplot
BXK0031_TN_plot <- ggplot(BXK0031_TN_TP_TSS.Early, aes(x=year_month, y=meanTN)) +
  geom_line() +
